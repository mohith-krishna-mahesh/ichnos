...
def get_active_theme_name() -> str:
    ...
    if theme_name in BUILTIN_THEMES or theme_name in cfg.get("custom_themes", {}):
        return theme_name
    return "hacker"
...
def get_available_themes() -> list[str]:
    """Returns list of all available theme names (builtins + user custom themes)."""
    cfg = load_config()
    custom_themes = list(cfg.get("custom_themes", {}).keys())
...
def register_ichnos_themes(app: App) -> None:
    """Registers all built-in and user-configured themes into the Textual application."""
